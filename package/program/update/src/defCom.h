...
// 更新方法对应的更新脚本
#define UPDATE_SHELL            "sh /usr/ibeacon/tool/updateIBeacon.sh"
#define REBOOT_SYSTEM           "/bin/busybox reboot"

// 检测文件格式是否符合要求脚本程序
#define CHECK_UPDATE_SHELL     "/usr/ibeacon/tool/checkIBeaconBin.sh"
